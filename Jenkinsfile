pipeline {
    ...
    stages {
        ...
        stage('Update K8S manifest & push to Repo'){
            steps {
                script{
                    withCredentials([usernamePassword(credentialsId: 'Anshu', passwordVariable: 'GIT_PASSWORD', usernameVariable: 'GIT_USERNAME')]) {
                        sh '''
                        cat deploy.yaml
                        ...
                        git remote -v
                        git push https://github.com/AnshuKumar380/K8S-Manifests.git HEAD:main
                        '''                        
                    }
                }
            }
